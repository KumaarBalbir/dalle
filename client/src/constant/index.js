/* The `export const surpriseMePrompts` is an array of strings that contains various prompts for
creative projects or ideas. These prompts can be used to inspire and challenge individuals to create
artwork, photography, digital art, or other creative works based on the given prompts. Each prompt
describes a unique and imaginative concept, such as an armchair in the shape of an avocado, a
surrealist painting of a cat playing checkers, or a photo of a cyborg exploring Tokyo at night. */
